  ...
  return (
    <div className=" w-[50rem] h-[29.25rem] flex font-poppins -mt-[14.18rem] absolute z-10">
      <div className=" w-1/2 bg-white h-full rounded-l-[2.5rem] flex flex-col items-center py-10 px-[3.12rem]  ">
        ...
        <h5 className=" text-[2.5] font-semibold mt-8 ">Join the club</h5>
      ...
      <div className=" w-1/2 h-full relative ">
        <Image
          ...
          className="rounded-r-[2.5rem] absolute"
        />
        <p className="absolute left-[1.87rem] bottom-[1.87rem] text-4xl text-white font-semibold">
